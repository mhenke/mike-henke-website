...
Welcome to the wonderful world of Wheels, I hope you will enjoy it! CFWheels is running now, next post will be how to get the cool rewrite.  You must be using Apache or IIS for this to work. Sorry people using the built in web server with ColdFusion, you are stuck using http://localhost/index.cfm/cfc_name/method_name instead of the cool http://localhost/cfc_name/method_name
